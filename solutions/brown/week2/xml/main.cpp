...
vector<Spending> LoadFromXml(istream &input) {
  ...
  transform(children.begin(), children.end(), back_inserter(spendings), [](const Node &node) {
    return Spending{node.AttributeValue<string>("category"), node.AttributeValue<int>("amount")};
  });
