...
public:
    ...
    bool CollideWith(const Unit& that) const override {
        return geo2d::Collide(this->geometry, that.point);
    }
    bool CollideWith(const Building& that) const override {
...
public:
    ...
    bool CollideWith(const Unit& that) const override {
        return geo2d::Collide(this->circle, that.point);
    }
    bool CollideWith(const Building& that) const override {
        return geo2d::Collide(this->circle, that.geometry);
    }
    bool CollideWith(const Tower& that) const override {
...
public:
    ...
    bool CollideWith(const Unit& that) const override {
        return geo2d::Collide(this->segment, that.point);
    }
    bool CollideWith(const Building& that) const override {
        return geo2d::Collide(this->segment, that.geometry);
    }
    bool CollideWith(const Tower& that) const override {
        return geo2d::Collide(this->segment, that.circle);
    }
    bool CollideWith(const Fence& that) const override {
        return geo2d::Collide(this->segment, that.segment);
    }
...
bool Unit::CollideWith(const Building& that) const {
    return geo2d::Collide(this->point, that.geometry);
}

bool Unit::CollideWith(const Tower& that) const {
    return geo2d::Collide(this->point, that.circle);
}

bool Unit::CollideWith(const Fence &that) const {
    return geo2d::Collide(this->point, that.segment);
}

bool Building::CollideWith(const Tower& that) const {
    return geo2d::Collide(this->geometry, that.circle);
}

bool Building::CollideWith(const Fence &that) const {
    return geo2d::Collide(this->geometry, that.segment);
}

bool Tower::CollideWith(const Fence &that) const {
    return geo2d::Collide(this->circle, that.segment);
}
