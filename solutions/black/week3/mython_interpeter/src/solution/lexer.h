...
namespace Parse {
  ...
  using TokenBase =
      std::variant<TokenType::Number, TokenType::Id, TokenType::Char, TokenType::String, TokenType::Class,
                   ...
                   TokenType::Print, TokenType::Indent, TokenType::Dedent, TokenType::And, TokenType::Or,
                   TokenType::Not, TokenType::Eq, TokenType::NotEq, TokenType::LessOrEq, TokenType::GreaterOrEq,
                   TokenType::None, TokenType::True, TokenType::False, TokenType::Eof>;
  ...
  class IndentedReader {
   public:
    ...
    int CurrentIndent() const { return current_indent; }

    int CurrentLineNumber() const { return line_number; }
   ...
   public:
    ...
    const T& Expect() const {
      if (!current.Is<T>()) {
        ...
        msg << "Expect token " << T() << " but got " << current << " at line " << char_reader.CurrentLineNumber();
